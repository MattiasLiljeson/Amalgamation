...
void CameraController::Update(float pElapsedTime)
{
	...
	/*AglVector3 targetToPos = Camera::GetInstance()->GetPosition() - Camera::GetInstance()->GetTarget();
	Rotate(targetToPos, dt, AglVector3(0, 1, 0));
	Camera::GetInstance()->MoveToPreserveTarget(Camera::GetInstance()->GetTarget() + targetToPos);*/
