...
Model* ModelBaseFactory::createModelDescription( const string& p_name, 
												 const string* p_path/*=NULL*/)
{
	...
	if (scene)
	{ 
		vector<Model*>* models = createAllModelData(scene,1);
...
vector<Model*>* ModelBaseFactory::createAllModelData( AglScene* p_scene, 
...
void ModelBaseFactory::readConnectionPoints(unsigned int p_modelNumber,
											Model* p_model, AglScene* p_scene)
{
