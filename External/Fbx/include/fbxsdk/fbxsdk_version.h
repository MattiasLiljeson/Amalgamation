...
#define FBXSDK_VERSION_NAME		"RC"		//string, ex: Alpha1, Alpha2, Beta1, Beta2, RC, Release
#define FBXSDK_VERSION_DATE		20121204	//yyyymmdd
...
//FBX SDK namespace definition
	...
	#define FBXSDK_NAMESPACE fbxsdk_2014_0_rc
#else
