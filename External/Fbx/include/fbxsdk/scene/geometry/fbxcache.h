...
public:
    ...
    //@{
        ...
        /** Open a cache file for writing.
          ...
          * \param pStatus                The FbxStatus object to hold error codes.
          */
        bool OpenFileForWrite(EMCFileCount pFileCount, double pSamplingFrameRate, const char* pChannelName, EMCDataType pMCDataType = eDoubleVectorArray, const char* pInterpretation = "Points", FbxStatus* pStatus = NULL);
    ...
    //@{
        ...
        /** Create an MC cache file from an PC2 cache file.
          ...
          */
        bool ConvertFromPC2ToMC(EMCFileCount pFileCount, double pSamplingFrameRate, FbxStatus* pStatus = NULL);
...
protected:
    bool OpenFile(EOpenFlag pFlag, EMCFileCount pFileCount, double pSamplingFrameRate, const char* pChannelName, const char* pInterpretation, unsigned int pSampleCount, unsigned int pPointCount, double pFrameStartOffset, FbxStatus* pStatus, EMCDataType pMCDataType = eDoubleVectorArray); 
